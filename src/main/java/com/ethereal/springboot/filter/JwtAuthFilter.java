package com.ethereal.springboot.filter;

import com.ethereal.springboot.common.ShiroContext;
import com.ethereal.springboot.config.JWTToken;
...
public class JwtAuthFilter extends AuthenticatingFilter {
    ...
    protected boolean onLoginSuccess(AuthenticationToken token, Subject subject, ServletRequest request, ServletResponse response) throws Exception {
        ...
        if(StringUtils.isNotBlank(newToken))
            httpResponse.setHeader(ShiroContext.AUTH_TOKEN_NAME, newToken);
    ...
    protected String getAuthzHeader(ServletRequest request) {
        ...
        String header = httpRequest.getHeader(ShiroContext.AUTH_TOKEN_NAME);
